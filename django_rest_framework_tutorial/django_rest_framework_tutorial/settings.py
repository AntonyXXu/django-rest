...
SECRET_KEY = 'django-insecure-!89z!=h^+jh5-+r1bk%i3d3i&)az4+@qhevq=l_=&bmf*xl9qv'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTIFICATION_CLASSES': ['rest_framework.authentication.TokenAuthentication']
}